...
<main>
  <section class="l-mv">
    <div class="p-mv">
      ...
      <h2 class="p-mv__text js-hero-text">L'homme est un roseau pensant</h2>
  ...
  <section class="l-about l-section u-js-fade">
    <div class="l-about__inner l-inner">
      <div class="p-about">
        ...
        <a href="/" class="c-arrow-link p-about__link">
    ...
    <div class="l-works__inner l-inner">
      <div class="p-works">
        ...
        <div class="p-works__text-link-container">
          ...
          <a href="/" class="c-arrow-link p-works__link">
  ...
  <section class="l-skills l-section u-title-bar u-js-fade">
